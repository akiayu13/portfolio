...
export default function Skills({}: Props) {
  ...
  return (
    ...
    >
      <h3 className="absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl md:text-4xl">
        Skills
      </h3>
      <h3 className="absolute top-36 uppercase tracking-[3px] text-gray-500 text-sm md:text-2xl">
